...
export default class Player extends Phaser.GameObjects.Sprite implements IPlayer {
    ...
    protected _w: Phaser.Input.Keyboard.Key;
    protected _a: Phaser.Input.Keyboard.Key;
    protected _s: Phaser.Input.Keyboard.Key;
    protected _d: Phaser.Input.Keyboard.Key;
    protected _animations: Array<{ sprite: string, key: string, frames: Array<number>, frameRate: number, yoyo: boolean, repeat: number }> = [
