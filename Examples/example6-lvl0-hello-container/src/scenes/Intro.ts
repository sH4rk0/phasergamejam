export default class Intro extends Phaser.Scene {
  ...
  create() {
    ...
    this._logo = this.add.image(512, 100, "logo").setScale(.8);
    ...
    this._text1 = this.add.text(512, 300, "Play").setOrigin(.5).setFontSize(40).setFontFamily("Roboto").setInteractive().on("pointerover", () => {
    ...
    this._text2 = this.add.text(512, 400, "Credits").setOrigin(.5).setFontSize(40).setFontFamily("Roboto").setInteractive()
      .on("pointerover", () => {
    ...
    let _chiudi = this.add.text(512, 450, "Chiudi").setOrigin(.5).setFontFamily("Roboto").setFontSize(30).setInteractive().on("pointerdown", () => {
