...
import BonusCoin from "../components/bonus/BonusCoin";
import Player from "../components/player/Player";
import Player4directions from "../components/player/Player4directions";
import Player2directions from "../components/player/Player2directions";
    ...
    this.physics.add.collider(
      ...
      (_player: any, _tile: any) => {
        ...
        if (_tile.properties.exit == true) {
          ...
          this.scene.restart({ level: this._level + 1 })
        }
