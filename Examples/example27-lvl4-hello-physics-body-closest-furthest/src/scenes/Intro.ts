export default class Intro extends Phaser.Scene {
  ...
  update(time: number, delta: number): void {
    ...
    let _closest = <Phaser.Physics.Arcade.StaticBody>this.physics.closest(this._sprite1, this._enemyGroup.getChildren());
    let _furthest = <Phaser.Physics.Arcade.StaticBody>this.physics.furthest(this._sprite1, this._enemyGroup.getChildren());
